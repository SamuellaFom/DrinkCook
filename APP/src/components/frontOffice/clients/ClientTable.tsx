...
export default function ClientTable({ data, onView, onEdit, onDelete }: Props) {
    const columns = useMemo(() => columnsClient(), []);
    ...
    const table = useMaterialReactTable({
        ...
        renderRowActions: ({ row }: { row: { original: Client } }) => (
            <div className="flex gap-2 items-center">
                ...
                {onView && (
                    <button
                        ...
                        aria-label={`Voir le client ${row.original.nom}`}
                ...
                <button
                    ...
                    aria-label={`Modifier le client ${row.original.nom}`}
                ...
                <button
                    ...
                    aria-label={`Supprimer un client ${row.original.nom}`}
